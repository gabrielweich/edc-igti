...
FILE_REQUIREMENTS=../src/lambda_requirements.txt
...
LAMBDA_FUNCTION=../../src/run_emr_steps.py
...
then
	...
	cp $LAMBDA_FUNCTION .
	echo "Compactando arquivo run_emr_steps_payload.zip"
	zip -r9 ../run_emr_steps_payload.zip . #Compacta o pacote para o deploy
